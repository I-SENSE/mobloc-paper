...
% Grid configurations for simple environment
multiplier = 3;
area_height_m = 5;
area_width_m = 8;
...
[csi_train, csi_test, labels_train, labels_test, ap_coords, freq_center, freq, ant_d, ap_n, cdf_title] = dloc_split.prepare_data_test_figure10a(DATASETS, SPLIT_IDX);
